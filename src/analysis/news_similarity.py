# в этом файле мы просто в основной функции на вход принимаем
# одну новость и сравниваем с бд где лежат остальные новости

# в качестве результата мы получаем вероятность и новость из бд
# на которую она наиболее похожа  если преодолевает порог


# TODO: подготовить тестовую бд, с которой и будем сравнивать текущую новость
# TODO: установить докер
# TODO: изучить Егора конфиг и сделать аналогичный
# TODO: написать алгоритм сравнения

# TODO: добавить фильтрацию для поиска по ключевым словам
